...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (Array.isArray(draft?.fromLocation?.coordinates)) {
        setFromCoordinates(draft.fromLocation.coordinates);
        setFromMapCenter(draft.fromLocation.coordinates);
      }

      if (Array.isArray(draft?.toLocation?.coordinates)) {
        setToCoordinates(draft.toLocation.coordinates);
        setToMapCenter(draft.toLocation.coordinates);
      }
