    ...
    const ensureYandexMapsReady = () => {
      ...
      return new Promise((resolve, reject) => {
        const waitForYmaps = () => {
          ...
          reject(new Error('Yandex Maps API loaded, but window.ymaps is unavailable'));
        };
        ...
        if (existingScript) {
          ...
          existingScript.addEventListener('load', waitForYmaps, { once: true });
