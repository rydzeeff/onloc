...
ALTER TABLE ONLY public.trip_alerts
    ADD CONSTRAINT trip_alerts_actor_user_id_fkey FOREIGN KEY (actor_user_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.trip_alerts
    ADD CONSTRAINT trip_alerts_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
